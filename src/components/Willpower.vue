<template>
  <v-container grid-list-md text-xs-center>
    ...
    <div>
        <img v-for="n in character.maxWillpower()" :key="''+n" src="/public/dot-filled.png"><img v-for="n in unusedSpace()" :key="''+n" src="/public/dot-empty.png">
    </div>
    <div>
        <img v-for="n in character.willpower" :key="''+n" src="/public/box-stroke.png"><img v-for="n in usedWillpower()" :key="''+n" src="/public/box-empty.png"><img v-for="n in unusedSpace()" :key="''+n" src="/public/box-empty-grey.png">
    </div>
    <div>
